 ...
 * @author Esraa
 */
@WebServlet(urlPatterns = {"/ShowNotification"})
public class ShowNotification extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            conn.statement = conn.connection.prepareStatement("select * from notificationcomments where `userEmail`='"+email+"' ");
            ...
            response.sendRedirect("ShowNotifications.jsp");
        }
    }
