 ...
 * @author Esraa
 */
@WebServlet(urlPatterns = {"/CloseAdminServlet"})
public class CloseAdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CloseAdminServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
