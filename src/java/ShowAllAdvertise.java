 ...
 * @author Esraa
 */
@WebServlet(urlPatterns = {"/ShowAllAdvertise"})
public class ShowAllAdvertise extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            conn.statement = conn.connection.prepareStatement("SELECT * FROM `advertise`");
            ...
            session.setAttribute("AdminAdvertises", collectionOfAdvertise);
            response.sendRedirect("AdminAdvertises.jsp");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ShowAllAdvertise.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
