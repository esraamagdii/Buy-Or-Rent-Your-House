 ...
 * @author Esraa
 */
@WebServlet(urlPatterns = {"/RemoveNotification"})
public class RemoveNotification extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            index+=1;    // because it start to count fron 1 
            ...
            conn.statement=(PreparedStatement) conn.connection.prepareStatement("delete  from to_notify where id="+index+" and user_mail='"+x.getEmail()+"'");
            conn.statement.executeUpdate();
            conn.statement.close();
            conn.connection.close();
            x.notification.remove(index-1);
            session.removeAttribute("mydata");
            session.setAttribute("mydata", x);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RemoveNotification.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
